...
final class AdminHomeViewController: BaseViewController {
    ...
    private let noReservationAnnouncementUILabel = UILabel().then{
        $0.textColor = UIColor(rgb: 0x937A75)
        $0.text = "예약 된 상담이 없습니다🙂"
        $0.numberOfLines = 3
    ...
    override func addView() {
        view.addSubviews(
            ...
            noReservationAnnouncementUILabel,
    ...
    override func setLayout() {
        ...
        self.noReservationAnnouncementUILabel.snp.makeConstraints{
